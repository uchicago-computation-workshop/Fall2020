...
quarter <- "Fall2020"
date <- "10/08"
week_folder <- "10-08_Clindaniel"


title <- "The Inka Writing System: An Exploration of Khipu Sign Conventions"


speaker <- "Jon Clindaniel"
department <- "Masters Program in Computational Social Science"
university <- "University of Chicago"
github_home <- "https://github.com/uchicago-computation-workshop"

#Update Weekly
issues_url <- "https://github.com/uchicago-computation-workshop/Fall2020/issues/2"
zoom_url <- "https://uchicago.zoom.us/meeting/register/tJwsdeuhrz4tEtaMuh47QL9m5QrsHiI4cZIV"
